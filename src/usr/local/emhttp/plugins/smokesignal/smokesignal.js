...
(function(){
  ...
  var SS_LANG = {
    en: {
      ...
      array_bad_devices: 'Array not clean: state={0} — {1}',
      array_counts: 'Array not clean: state={0} — disabled={1} invalid={2} missing={3}',
      array_bad_devices_only: 'Unhealthy device assignment(s): {0}',
    ...
    de: {
      ...
      array_bad_devices: 'Array nicht sauber: Zustand={0} — {1}',
      array_counts: 'Array nicht sauber: Zustand={0} — deaktiviert={1} ungültig={2} fehlend={3}',
      array_bad_devices_only: 'Ungesunde Gerätezuweisung(en): {0}',
